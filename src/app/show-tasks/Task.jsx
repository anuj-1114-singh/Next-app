        ...
        >
            <div className="p-5">
                <div className="flex justify-between">
                    <h1 className="text-2xl text-white font-semibold">{task.title}</h1>

                    <span
                        onClick={() => {
                            deleteTask(task._id);
                        }}
                        className="shadow-lg text-white hover:bg-gray-900 bg-gray-950 rounded-full w-9 h-9 flex justify-center items-center cursor-pointer "
                    >
                        <RxCross1 />
                    </span>
                </div>
